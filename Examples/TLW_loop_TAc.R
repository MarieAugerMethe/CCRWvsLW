# Run the TLW simulations of the Appendix with local turn method
...
write.csv(AICcRes, "TLW_AICc_Res.csv", row.names=FALSE)
write.csv(prRes, "TLW_pr_Res.csv", row.names=FALSE)
write.csv(prResDet, "TLW_prDet_Res.csv", row.names=FALSE)
write.csv(parRes, "TLW_par_Res.csv", row.names=FALSE)
write.csv(ciRes, "TLW_ci_Res.csv", row.names=FALSE)
